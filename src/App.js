    ...
    <div className="App">
      {fetchedData ? (
        <Row justify="space-around">
          <Col className="icon__outer"><Image src={icon} alt="" width="50%" preview={false}/></Col>
          <Col lg={11} md={22}>
            <div className="flex__col h__100">
          <Typography.Text className="heading">INDIA COVID-19 Tracker</Typography.Text>
          <Typography.Text className="color__olive">Let's all pray to make our Earth Covid-19 free soon,Stay Safe and do The Locate
            </Typography.Text> 
            </div>
          ...
          <Typography.Text className="color__olive">HOVER OVER A STATE FOR MORE DETAILS
          </Typography.Text> 
            </div>
